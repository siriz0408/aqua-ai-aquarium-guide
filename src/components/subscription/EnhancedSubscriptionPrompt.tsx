    ...
    <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20 max-w-4xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-blue-600 dark:text-blue-300">
          Get unlimited access to all premium features with our 100% subscription model.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-950/50 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
          <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-2">What you get:</h4>
          <ol className="text-sm text-blue-700 dark:text-blue-300 space-y-1 text-left">
            <li>• Unlimited AI-powered aquarium assistance</li>
            <li>• Advanced setup planning and recommendations</li>
            <li>• Complete tank management tools</li>
        ...
        <p className="text-xs text-blue-600 dark:text-blue-400 text-center">
          Cancel anytime • Secure payment via Stripe • Full feature access
        </p>
      </CardContent>
    </Card>
  );
