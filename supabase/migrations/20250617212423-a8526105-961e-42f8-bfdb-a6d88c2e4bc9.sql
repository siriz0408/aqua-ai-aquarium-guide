...
-- Fix the check_user_admin_status function with proper search_path
...
-- Fix the get_user_admin_status function with proper search_path
...
-- Fix the check_is_admin function with proper search_path
...
-- Fix the can_access_ai_features function with proper search_path
