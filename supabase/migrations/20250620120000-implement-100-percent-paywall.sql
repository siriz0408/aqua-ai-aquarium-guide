...
-- 3. Remove trial-related columns from profiles (optional cleanup)
...
-- ALTER TABLE profiles DROP COLUMN IF EXISTS has_used_trial;
-- ALTER TABLE profiles DROP COLUMN IF EXISTS trial_type;

-- 4. Update handle_new_user to not start any trials
